...
**GitHub account.** The demo notebook is hosted on GitHub. If you don't have an account, create one (free) at [github.com](https://github.com). Once you have an account, clone the repo:
